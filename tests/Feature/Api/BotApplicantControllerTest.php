...
class BotApplicantControllerTest extends TestCase
{
    ...
    public function test_send_initial_data_updates_applicant()
    {
        ...
        $conversation = Conversation::factory()->create(['chat_id' => $applicant->chat_id]);
        ...
        $this->assertEquals('Juan Perez', $conversation->fresh()->user_name);
    }
    ...
    public function test_reschedule_removes_from_group_and_sends_link()
    {
        ...
        $conversation = Conversation::factory()->create(['chat_id' => $applicant->chat_id]);
        Message::factory()->create(['conversation_id' => $conversation->id, 'role' => 'user']);
