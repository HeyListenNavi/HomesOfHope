    ...
    public function run(): void
    {
        ...
        $stage1->questions()->createMany([
            [
                ...
                'validation_rules' => ['requerido', 'tipo' => 'texto'],
                'approval_criteria' => [],
                'order' => 1,
            ],
            [
            ...
            [
                ...
                'validation_rules' => ['requerido', 'tipo' => 'texto', 'otro' => 'debe ser si o no'],
            ...
            [
                ...
                'validation_rules' => ['requerido', 'tipo' => 'numerico', 'minimo' => '1'],
        ...
        $stage2->questions()->createMany([
            ...
            [
                ...
                'validation_rules' => ['requerido', 'tipo' => 'numerico', 'minimo' => '0'],
                'approval_criteria' => null,
                'order' => 6,
            ],
        ]);
        ...
        $stage3->questions()->createMany([
            ...
            [
                ...
                'validation_rules' => ['tipo' => 'numerico', 'minimo' => '18'],
                'approval_criteria' => null,
                'order' => 2,
            ],
            [
            ...
            [
                ...
                'validation_rules' => ['tipo' => 'numerico', 'minimo' => '0'],
                'approval_criteria' => null,
                'order' => 6,
            ],
            [
                ...
                'validation_rules' => ['tipo' => 'texto', 'otro' => 'debe ser si o no'],
                'approval_criteria' => null,
                'order' => 7,
            ],
            [
            ...
            [
                'key' => 'madre_deportada',
                'question_text' => '¿Ha sido deportada recientemente de los Estados Unidos?',
                'validation_rules' => ['tipo' => 'texto', 'otro' => 'debe ser si o no'],
                'approval_criteria' => null,
                'order' => 9,
            ],
            ...
            [
                'key' => 'otros_miembros',
                'question_text' => '¿Quiénes más vivirían en la casa de esperanza si se les llega a construir? Dime su nombre, edad y relación con la familia.',
                'validation_rules' => ['otro' => 'texto'],
                'approval_criteria' => null,
                'order' => 22,
            ],
            ...
            [
                ...
                'question_text' => 'Envia las coorderadas de tu terreno por aqui en WhatsApp',
                'validation_rules' => ['requerido', 'tipo' => 'texto'],
                'approval_criteria' => null,
                'order' => 25,
            ],
